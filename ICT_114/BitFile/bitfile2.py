from ICT_114.BitFile.bitfile import COUTEAU
...
def main():
    ...
    while choix != 9:
        ...
        # Utilisation de match-case pour exécuter l'action correspondante
        match choix:
            case 1:
                afficher_inventaire(inventaire, objets)
            case 2:
                inventaire = ajouter_couteau(inventaire)
            case 3:
                inventaire = supprimer_couteau(inventaire)
            case 4:
                inventaire = ajouter_ou_supprimer_objet(inventaire, objets)
            case 9:
                print("Bye...")
            case _:
                print("Réessayez")
